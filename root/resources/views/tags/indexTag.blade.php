				...
				<div class="col-sm-8">
					<div class="post-content">
						...
						<div class="post-sample-info">
							...
							<a href="{{ route('post.show', ['id' => $post->id, 'slug' => $post->slug]) }}" class="btn btn-default btn-xs read-more">čítať viac</a><br>
